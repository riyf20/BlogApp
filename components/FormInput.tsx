...
// This defines all props that will be entered
type FormInputProps ={ 
...
const FormInput = ({invalid, placeholder, value, parentInvalid, setValue, setValueInvalid, setParentInvalid, error}: FormInputProps) => {
